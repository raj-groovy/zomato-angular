...
export class MasterService {
  ...
  //   return this.http.get(
  //     'https://freeapi.miniprojectideas.com/api/zomato/GetRestaurantByRestaurantId?restaurantID=' +
  //       name
  //   );
  // }
  login(obj: any) {
  ...
  //   return this.http.post(
  //     'https://freeapi.miniprojectideas.com/api/zomato/UpdateCartQuantity',
  //     obj
  //   );
  // }
}
